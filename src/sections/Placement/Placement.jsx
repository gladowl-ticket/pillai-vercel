...
<section className="container pb-12" id="placement">
    <div className="flex flex-wrap-reverse">
        ...
        <div className="w-full md:w-[50%] md:ps-4">
            <p className='mb-4 lg:mb-0 xl:mb-4 text-sm'>Placements Highlights</p>
            <h2 className='text-4xl md:text-5xl lg:text-[42px] xl:text-5xl text-red-800 font-bold mb-4'><span className="text-orange-400 font-normal">Top Global </span>Companies <br /> Recruit Our Talent</h2>
            ...
            <div className="flex flex-wrap lg:hidden xl:flex">
                {head.map((item, index) => (
    ...
    <div className="hidden flex-wrap lg:flex xl:hidden">
        {head.map((item, index) => (
        <div key={index} className="w-1/2 md:w-1/4 px-4 mb-4">
            <div className="border border-gray-300 bg-gray-200 py-3 px-1 rounded-xl text-center">
                <h4 className="text-3xl text-black texte-center font-extrabold mb-2">{item}</h4>
                <p className="text-sm">{desc[index]}</p>
            </div>
